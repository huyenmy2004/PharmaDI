            ...
            <div class="cart-list-prod-list">
                ...
                <div class="cart-list-prod-list-prod">
                    ...
                    <div style="grid-column: span 4; display: flex; align-items: center">
                       <img src="../asset/image/prod.jpg" alt="product" style="width: 68px; height: 68px; object-fit: contain;">
                       <div style="display: flex; flex-direction: column;">
                            <span style="font-weight: 600; font-size: 14px; padding: 5px 0; max-width: 90%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">Nước Uống Chống Say Tàu Xe Donsung (H/30c/30ml) </span>
                            <span style="font-weight: 500; font-size: 12px;">Hộp 30 chai x 30ml</span>
                        </div>
                    </div>
                    <form action="" style="grid-column: span 3; display: flex; align-items: center; margin: 0">
                    ...
                    <span style="display: flex; align-items: center; font-weight: 600; font-size: 16px; color: #0071AF; padding: 5px 0;grid-column: span 2">99.000đ</span>
